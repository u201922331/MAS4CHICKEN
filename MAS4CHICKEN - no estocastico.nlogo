...
to setup
  ...
  ; Cargar el mapa
  ;set patch-data [[-3	4	0]	[-2	4	0]	[-1	4	0]	[0	4	0]	[1	4	27]	[2	4	0]	[3	4	0]	[4	4	0]	[-3	3	0]	[-2	3	45]	[-1	3	45]	[0	3	45]	[1	3	45]	[2	3	45]	[3	3	45]	[4	3	0]	[-3	2	0]	[-2	2	45]	[-1	2	45]	[0	2	35]	[1	2	36]	[2	2	45]	[3	2	45]	[4	2	0]	[-3	1	0]	[-2	1	45]	[-1	1	45]	[0	1	45]	[1	1	45]	[2	1	45]	[3	1	45]	[4	1	0]	[-3	0	0]	[-2	0	45]	[-1	0	45]	[0	0	45]	[1	0	45]	[2	0	45]	[3	0	45]	[4	0	0]	[-3	-1	0]	[-2	-1	45]	[-1	-1	6]	[0	-1	5]	[1	-1	0]	[2	-1	0]	[3	-1	0]	[4	-1	0]	[-3	-2	0]	[-2	-2	45]	[-1	-2	45]	[0	-2	45]	[1	-2	4]	[2	-2	45]	[3	-2	45]	[4	-2	0]	[-3	-3	0]	[-2	-3	45]	[-1	-3	45]	[0	-3	45]	[1	-3	45]	[2	-3	45]	[3	-3	45]	[4	-3	0]	[-3	-4	0]	[-2	-4	0]	[-1	-4	0]	[0	-4	0]	[1	-4	0]	[2	-4	0]	[3	-4	0]	[4	-4	0]]
  ...
  create-chefs COCINEROS [
    ...
    set food-time Tiempo-preparacion * 60
...
to go
  ...
  ask waiters [
    ...
    if not empty? path                   ; Siguiente posicion del mesero
    [
...
<experiments>
  ...
  <experiment name="experimento-no-estocastico" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    ...
    <enumeratedValueSet variable="Umbral-tiempo-espera">
      <value value="20"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Cocineros">
      <value value="10"/>
  ...
  <experiment name="experimento-no-estocastico 2" repetitions="3" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>get-waiting-time</metric>
    <enumeratedValueSet variable="Intervalo-Pausa">
